...
public:
    ...
    bool addPerspectCamera(Camera* camera);
    ...
    QVector<Camera*> GetPerspectCameras() { return m_perspectCameras; }
...
signals:
    ...
    void cameraRemoved(QObject* object);
...
private:
    ...
    Camera * m_camera;
    QVector<Camera*> m_perspectCameras;
